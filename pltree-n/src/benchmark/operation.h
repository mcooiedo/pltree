...
void insert_without_epoch(Alert<T, P> *index, struct Range *_range) {
...
// Without Epoch operation
template <class T, class P>
void search_without_epoch(Alert<T, P> *index, struct Range *_range) {
...
// Without Epoch operation
template <class T, class P>
void range_without_epoch(Alert<T, P> *index, struct Range *_range) {
    //LOG(00);
    set_addr(_range->id/2);
    set_affinity(_range->id);
    uint64_t num = _range->num;
...
template <class T, class P>
void range_debug(Alert<T, P> *index, struct Range *_range) {
    set_affinity(_range->id);
    uint64_t num = _range->num;
...
// Without Epoch operation
template <class T, class P>
void erase_without_epoch(Alert<T, P> *index, struct Range *_range) {
    set_addr(_range->id/2);
    set_affinity(_range->id);
    uint64_t num = _range->num;
    T *key_array = reinterpret_cast<T *>(_range->workload);
...
template <class T, class P>
void update_without_epoch(Alert<T, P> *index, struct Range *_range) {
    set_addr(_range->id/2);
    set_affinity(_range->id);
    uint64_t num = _range->num;
    T *key_array = reinterpret_cast<T *>(_range->workload);
...
template <class T, class P>
void mixed_without_epoch(Alert<T, P> *index, struct Range *_range) {
    set_addr(_range->id/2);
    set_affinity(_range->id);
    uint64_t num = _range->num;
