...
#ifndef PALERT_ALLOCATOR_H
#define PALERT_ALLOCATOR_H
...
#else
static const char *pool_name = "/mnt/pmem0/baotong/template.data";//;"/home/mcooiedo/文档/code/template"
static const uint64_t pool_size =40UL * 1024 * 1024 * 1024UL ;// 20UL * 1024 * 1024 * 1024
